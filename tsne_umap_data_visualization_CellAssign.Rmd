---
title: "tsne_umap_data_visualization" with cell assign!
author: "Shaila Fye"
date: "6/25/2020"
...
coordinates$tSNE_1
coordinates[0] #cell
write.table(coordinates,file = "/Users/shailafye/Documents/summer2020/puram/puram_tnse_coordinates.txt")
...
p1 = ggplot(data.plot, aes(x = tsne1, y = tsne2, cell=Cell)) +
  ...
  theme_pubr(base_size = 10) + ggtitle("CellAssign Annotations")
...
#tcell --> steelblue4, orchid
p1_tcell <- p1 + scale_color_manual(values = c("grey25", "red", "grey25", "grey25", "grey25", "grey25","grey25", "red", "grey25"))+ ggtitle("Cell Assign Annotations - T Cells") 
#bcell --> cyan1
p1_bcell <- p1 + scale_color_manual(values = c("red", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25"))+ ggtitle("Cell Assign Annotations - B Cells") 
#macrophage --> orange 
p1_macrophage <- p1 + scale_color_manual(values = c("grey25", "grey25", "grey25", "grey25", "red", "grey25","grey25", "grey25", "grey25"))+ ggtitle("Cell Assign Annotations - Macrophage Cells") 
...
p3 = ggplot(data.plot2, aes(x = tsne1, y = tsne2, cell=Cell)) +
  geom_point(aes(color = Cell, stroke = 0)) +
  theme_pubr(base_size = 10) + ggtitle("Published Cell Type  Annotations")
...
#make everything grey25 and the cells we want in red
#tcell --> steelblue4, orchid
p3_tcell <- p3 + scale_color_manual(values = c("grey25", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "red")) + ggtitle("Published Cell Type Annotations - T Cells")
#bcell --> cyan1
p3_bcell<- p3 + scale_color_manual(values = c("red", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25")) + ggtitle("Published Cell Type Annotations - B Cells")
#macrophage --> orange 
p3_macrophage<- p3 + scale_color_manual(values = c("grey25", "grey25", "grey25", "grey25", "grey25", "red","grey25", "grey25", "grey25", "grey25")) + ggtitle("Published Cell Type Annotations - Macrophage Cells")
