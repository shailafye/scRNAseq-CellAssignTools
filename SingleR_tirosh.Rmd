...
"/Users/shailafye/Documents/summer2020/tirosh/melanoma_tirosh_alldata"
```{r}
library(SingleR)
...
data<- read.delim(file="/Users/shailafye/Documents/summer2020/tirosh/melanoma_tirosh_alldata", sep = "\t")
...
sc <- SingleCellExperiment(
    ...
    metadata=list(study="GSE72056") #replace
)
...
library(scater)
scc <- logNormCounts(sc) #check if this is necessary!
...
```{r}
pred.hesc <- SingleR(test = scc, ref = hpca.se, labels = hpca.se$label.main) #2-3 minutes to run
pred.hesc
head(pred.hesc)
```
...
write.table(pred.hesc$labels,file="/Users/shailafye/Documents/summer2020/tirosh/Tirosh_celltype_singleR", sep = "\t")
