---
title: "tsne_umap_CHETAH_tirosh"
author: "Shaila Fye"
date: "7/28/2020"
output: html_document
---

- tirosh data set being used
- CHETAH

/Users/shailafye/Documents/summer2020/tirosh/tirosh_celltype_CHETAH_1
...
cell_assign <-read.delim(file ="/Users/shailafye/Documents/summer2020/tirosh/tirosh_celltype_CHETAH_1", stringsAsFactors=F)
class(cell_assign)
...
p1 = ggplot(data.plot, aes(x = tsne1, y = tsne2, cell=Cell)) +
  ...
  theme_pubr(base_size = 10)+ ggtitle("CHETAH Annotations (Tirosh)")

p1_colortest <- p1 + scale_color_manual(values = c("cyan1", "orchid", "darkorange", "mediumseagreen", "orange", "slateblue1","gold", "steelblue4", "violetred3"))+ ggtitle("SingleR Annotations (Tirosh)")  #10 -  "#CC79A7"

saveRDS(p1, file = "/Users/shailafye/Documents/summer2020/tirosh/tirosh_tsne_CHETAH.rds")
...
p1_umap
p1_umap_colortest <- p1_umap + scale_color_manual(values = c("cyan1", "orchid", "darkorange", "mediumseagreen", "orange", "slateblue1","gold", "steelblue4", "violetred3"))+ ggtitle("CHETAH Annotations (Tirosh)")  #10 -  "#CC79A7"


saveRDS(p1_umap, file = "/Users/shailafye/Documents/summer2020/tirosh/tirosh_umap_CHETAH.rds")
