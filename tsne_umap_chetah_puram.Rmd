...
coordinates = Embeddings(s_obj[["tsne"]]) #make sure you load scran and seurat
...
chetah <-read.delim(file ="/Users/shailafye/Documents/summer2020/puram/chetah/celltype_CHETAH_1", stringsAsFactors=F)
class(chetah)
df2 = data.frame(cell = coordinates[0],
                 cell.type = chetah,
                       stringsAsFactors = F)
df1 #cells and tsne coordinates
df2 #cell type, chetah
...
p1 = ggplot(data.plot, aes(x = tsne1, y = tsne2, cell=Cell)) +
  ...
  theme_pubr(base_size = 10) + ggtitle("CHETAH Annotations")

p1_colortest <- p1 + scale_color_manual(values = c("cyan1", "orchid", "darkorange", "mediumseagreen", "orange", "slateblue1","gold", "steelblue4", "violetred3"))+ ggtitle("CHETAH Annotations")  #10 -  "#CC79A7"

#to just visualize one cell type on tsne
#make everything grey25 and the cells we want in red
#tcell
p1_tcell <- p1 + scale_color_manual(values = c("grey25", "grey25", "red", "red","grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25", "red","grey25"))+ ggtitle("CHETAH - T Cells") 
#bcell
p1_bcell <- p1 + scale_color_manual(values = c("red", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25", "grey25","grey25"))+ ggtitle("CHETAH - B Cells") 
#macrophage
p1_macrophage <- p1 + scale_color_manual(values = c("grey25", "grey25", "grey25", "grey25","grey25", "grey25", "red", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25", "grey25","grey25"))+ ggtitle("CHETAH - Macrophage Cells") 


saveRDS(p1, file = "/Users/shailafye/Documents/summer2020/puram/chetah/tsne_chetah.rds")
...
saveRDS(p1_umap, file = "/Users/shailafye/Documents/summer2020/puram/chetah/umap_CHETA.rds")
