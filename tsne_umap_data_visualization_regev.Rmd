---
title: "tsne_umap_data_visualization_regev"
author: "Shaila Fye"
date: "7/30/2020"
...
finalData <- "/Users/shailafye/Documents/summer2020/regev/regev_alldata.txt" 

#path to save store the tSNE and UMAP plot in 
pathTSNE_UMAP <- "/Users/shailafye/Documents/summer2020/regev"
...
cellType <- "/Users/shailafye/Documents/summer2020/regev/revev_celltype_singleR.txt"


#cell type that was published
publishedCellType <- "/Users/shailafye/Documents/summer2020/regev/published_cellTypes_regev.txt"



#whichever cell type automated software was used 
package <- "SinlgeR" #cellAssign, SingleR, CHETAH
#where is the data from - author ex: Puram
dataAuthor <- "regev"
#save tsne with celltypes
cellTypetSNE <- paste(pathTSNE_UMAP, "/TSNE_", package,"_",dataAuthor,".rds", sep="")


#save tsne with celltypes
PublishedCellTypetSNE <- paste(pathTSNE_UMAP, "/TSNE_published_", dataAuthor,".rds", sep="")


#save UMAP with celltypes
cellTypeUMAP <- paste(pathTSNE_UMAP, "/UMAP_", package,"_",dataAuthor,".rds", sep="")


#save UMAP with celltypes
PublishedCellTypeUMAP <- paste(pathTSNE_UMAP, "/UMAP_published_", dataAuthor,".rds", sep="")
...
#tsne
s_obj = RunTSNE(s_obj,check_duplicates = FALSE)
...
coordinates$tSNE_1
coordinates[0] #cell
write.table(coordinates,file = "/Users/shailafye/Documents/summer2020/regev/regev_tnse_coordinates.txt")
...
colnames(published_annotations)
published_annotations$x
