---
title: "tsne_umap_singleR"
author: "Shaila Fye"
date: "7/13/2020"
output: html_document
---
- puram data set being used
- SINGLE R CELL ASSIGN
...
r1 = read.table ("/Users/shailafye/Documents/summer2020/puram/head_and_neck_all_data.txt", header= TRUE, row.names = 1)
str(r1)
head(r1)
...
s_obj <- readRDS(file = "/Users/shailafye/Documents/summer2020/puram/tnse_attempt1.rds")
...
#need to now use singleR annotations
#add our generated cell type on top of tsne
singleR <-read.delim(file ="/Users/shailafye/Documents/summer2020/puram/celltype_singleR_1", stringsAsFactors=F)
class(singleR)
...
p1 = ggplot(data.plot, aes(x = tsne1, y = tsne2, cell=Cell)) +
  ...
  theme_pubr(base_size = 10)+ ggtitle("SingleR Annotations")

p1_colortest <- p1 + scale_color_manual(values = c("cyan1", "orchid", "darkorange", "mediumseagreen", "orange", "slateblue1","gold", "steelblue4", "violetred3"))+ ggtitle("SingleR Annotations")  #10 -  "#CC79A7"

#to just visualize one cell type on tsne
#make everything grey25 and the cells we want in red
#tcell
p1_tcell <- p1 + scale_color_manual(values = c("grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25","grey25","grey25","grey25", "red","grey25"))+ ggtitle("SingleR - T Cells") 
#bcell
p1_bcell <- p1 + scale_color_manual(values = c("red", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25","grey25","grey25","grey25", "grey25","grey25"))+ ggtitle("SingleR - B Cells") 
#macrophage
p1_macrophage <- p1 + scale_color_manual(values = c("grey25", "grey25", "grey25", "grey25","grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25", "grey25","grey25", "red", "grey25", "grey25","grey25", "grey25", "grey25", "grey25","grey25","grey25","grey25","grey25", "grey25","grey25"))+ ggtitle("SingleR - Macrophage Cells") 


saveRDS(p1, file = "/Users/shailafye/Documents/summer2020/puram/singleR/tsne_SingleR.rds")
...
pbmc <- readRDS(file = "/Users/shailafye/Documents/summer2020/puram/umap_attempt1.rds")
...
p1_umap = ggplot(data.plot_umap, aes(x = UMAP_1, y = UMAP_2, cell=Cell)) +
  ...
  theme_pubr(base_size = 10) + ggtitle("SingleR  Annotations")
p1_umap
p1_umap_colortest <- p1_umap + scale_color_manual(values = c("cyan1", "orchid", "darkorange", "mediumseagreen", "orange", "slateblue1","gold", "steelblue4", "violetred3"))+ ggtitle("SingleR  Annotations")  #10 -  "#CC79A7"


saveRDS(p1_umap, file = "/Users/shailafye/Documents/summer2020/puram/singleR/umap_singleR.rds")
